...
```
backend/tests/
├── test_vakten.py           # Vision AI (20KB, 560 lines)
├── test_navigator.py        # NAVTEX (23KB, 719 lines)
├── test_nmea_gps.py         # GPS (22KB, 700+ lines)
├── test_legen.py            # Medical (19KB, 600+ lines)
├── test_navi.py             # Conversational AI (18KB, 550+ lines)
├── test_psykologen.py       # Mental Health (22KB, 680+ lines)
├── test_ingenioren.py       # Diagnostics (19KB, 600+ lines)
├── test_api.py              # API endpoints (existing)
├── test_database.py         # Database operations (existing)
├── test_error_handling.py   # Error handling (existing)
├── test_models.py           # Database models (existing)
├── test_signalk.py          # Signal K integration (existing)
