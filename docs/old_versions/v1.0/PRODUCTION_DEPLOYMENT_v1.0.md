...
- ✅ Navi AI - Real Ollama models (requires model download)
- ✅ Vakten - Real camera + YOLOv8 vision (requires OpenCV + ultralytics)
- ✅ NMEA GPS - Real GPS hardware (requires /dev/ttyUSB0 GPS module)
- ✅ Signal K - Real Signal K server (if available)
...
### NMEA GPS
- **Before**: Simulated position at 78.2232°N, 15.6267°E (Svalbard)
...
**Status**: ✅ Production-ready when hardware is available
