#!/bin/bash
# Quick fix for docker-compose.yml YAML syntax error (Jetson backend)
...
if [ -f "docker-compose.yml.backup" ]; then
    ...
    echo "Creating fresh docker-compose.yml for Jetson backend..."
...
EOF
    ...
    echo "Created fresh docker-compose.yml"
fi
