# Reorganize docs into current/guides/reference/archived buckets
...
function Move-Files($files, $dest) {
...
Move-Files $currentFiles "docs\current"
Move-Files $guidesFiles "docs\guides"
Move-Files $referenceFiles "docs\reference"
Move-Files $generalFiles "docs\archived\GENERAL"
Move-Files $technicalFiles "docs\archived\TECHNICAL"
Move-Files $integrationsFiles "docs\archived\INTEGRATIONS"
