...
print("[STEP 1] Moving current docs...")
print(f"Moved {move_files(current_files, 'docs/current')} files")

print("[STEP 2] Moving guides...")
print(f"Moved {move_files(guides_files, 'docs/guides')} files")

print("[STEP 3] Moving references...")
print(f"Moved {move_files(reference_files, 'docs/reference')} files")

print("[STEP 4] Archiving general docs...")
print(f"Moved {move_files(general_files, 'docs/archived/GENERAL')} files")

print("[STEP 5] Archiving technical docs...")
print(f"Moved {move_files(technical_files, 'docs/archived/TECHNICAL')} files")

print("[STEP 6] Archiving integrations docs...")
print(f"Moved {move_files(integrations_files, 'docs/archived/INTEGRATIONS')} files")
