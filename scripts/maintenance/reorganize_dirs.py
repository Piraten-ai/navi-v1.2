...
dirs = [
    ...
    r"docs\guides",
    r"docs\reference",
    r"docs\archived\GENERAL",
    r"docs\archived\TECHNICAL",
    r"docs\archived\INTEGRATIONS",
    r"docs\hardware-manuals",
    r"scripts",
]
...
move_files(current_files, r"docs\current")
move_files(guides_files, r"docs\guides")
move_files(reference_files, r"docs\reference")
move_files(general_files, r"docs\archived\GENERAL")
move_files(technical_files, r"docs\archived\TECHNICAL")
move_files(integrations_files, r"docs\archived\INTEGRATIONS")
